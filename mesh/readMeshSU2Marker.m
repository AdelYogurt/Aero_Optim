function [part_list,point_list,geometry]=readMeshSU2Marker...
...
if exist(mesh_filestr,'file') ~= 2
    error('readMeshSU2Marker: mesh file do not exist')
else
...
if INFORMATION
    disp('readMeshSU2Marker: read mash data begin');
end
...
if strcmp(point_number_string{1},'NPOIN=')
    ...
    error('readMeshSU2Marker:NPOIN do not exist')
end
...
if INFORMATION
    disp('readMeshSU2Marker: read mash data done!')
end
