...
% 
% WWD_coord=waverider_wing.calCoord(point_list,marker_index_list);
% save('mesh_data_WWD.mat','WWD_coord','marker_index_list','-append')
% 
% % % write coord
% % writeCoord(WWD_coord,2,'WWD');
...
load('mesh_data_WWD.mat','WWD_coord')
mesh_point=waverider_wing.calMeshPoint(WWD_coord);
save('mesh_data_WWD.mat','mesh_point','-append')
