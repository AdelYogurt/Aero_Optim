...
# run command
# sbatch -p amd_512 -N 1 -n 128 -o eval_model.log eval_model.sh
# sbatch -p amd_512 -o eval_model.log eval_model.sh
...
/public3/wshome/ws173/scg7758/.conda/envs/zyHGV/bin/python3 eval_model.py
