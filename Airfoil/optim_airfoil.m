...
geom_param.mesh_coord=load('mesh/mesh_data_airfoil.mat','mesh_coord').mesh_coord;
...
% geo_in.Poles_low=importdata('geom/NACA0012_CSTshape_low.txt');
% geo_in.C_par_up=[0.5,1.0];
% geo_in.Poles_up=importdata('geom/NACA0012_CSTshape_up.txt');
