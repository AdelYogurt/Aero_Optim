...
% % NACA0012
% figure(1);
% airfoil_data=importdata('data/NACA0012.txt');
...
% RAE2822
airfoil_data=importdata('data/RAE2822.txt');
...
%% draw
% CST2D_curve_up=CurveCST2D(1,1,shape_fun_up,class_par_Y);
% CST2D_curve_low=CurveCST2D(1,-1,shape_fun_low,class_par_Y);
% 
