...
# run command
# sbatch -p amd_512 -N 1 -n 128 -o slave2.log slave2.sh
# sbatch -p amd_512 -o slave2.log slave2.sh
...
/public3/wshome/ws173/scg7758/.conda/envs/zyHGV/bin/python3 slave2.py
