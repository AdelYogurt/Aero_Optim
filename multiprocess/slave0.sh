...
# run command
# sbatch -p amd_512 -N 1 -n 128 -o slave0.log slave0.sh
# sbatch -p amd_512 -o slave0.log slave0.sh
...
/public3/wshome/ws173/scg7758/.conda/envs/zyHGV/bin/python3 slave0.py
