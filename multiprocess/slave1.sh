...
# run command
# sbatch -p amd_512 -N 1 -n 128 -o slave1.log slave1.sh
# sbatch -p amd_512 -o slave1.log slave1.sh
...
/public3/wshome/ws173/scg7758/.conda/envs/zyHGV/bin/python3 slave1.py
