...
# run command
# sbatch -p amd_512 -N 1 -n 128 -o OptBaseMF.log OptBaseMF.sh
# sbatch -p amd_512 -o OptBaseMF.log OptBaseMF.sh
...
/public3/wshome/ws173/scg7758/.conda/envs/zyHGV/bin/python3 OptBaseMF.py
