...
# run command
# sbatch -p amd_512 -N 1 -n 128 -o OptBaseSF.log OptBaseSF.sh
# sbatch -p amd_512 -o OptBaseSF.log OptBaseSF.sh
...
/public3/wshome/ws173/scg7758/.conda/envs/zyHGV/bin/python3 OptBaseSF.py
