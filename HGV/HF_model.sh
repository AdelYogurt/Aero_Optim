...
# run command
# sbatch -p amd_512 -N 1 -n 128 -o HF_model.log HF_model.sh
# sbatch -p amd_512 -o HF_model.log HF_model.sh
...
/public3/wshome/ws173/scg7758/.conda/envs/zyHGV/bin/python3 HF_model.py
